  ...
  (
    ...
    if (cloud) {
      return (
        <svg
          ...
          height="55"
        >
          <path d="M4.4,20.5c-1.1,0-2-0.4-2.8-1.1c-0.7-0.7-1.1-1.6-1.1-2.6c0-1.1,0.4-1.9,1.1-2.6c0.8-0.7,1.7-1.1,2.8-1.1
          ...
          <path d="M274.6,17.9v-4h-1.5v-0.8h3.9v0.8h-1.5v4H274.6z M277.9,17.9l0.2-4.8h0.9l1.5,3.1l1.5-3.1h0.9l0.2,4.8h-0.8
    ...
    return (
      ...
      >
        ...
        <path d="M165.1,17.9v-4h-1.5v-0.8h3.9v0.8H166v4H165.1z M168.3,17.9l0.2-4.8h0.9l1.5,3.1l1.5-3.1h0.9l0.2,4.8h-0.8
