...
export const SparkleSpinner: FunctionComponent<Props> = ({
  id,
  ref,
  style,
  ...
  const animationState = classnames({
    'cf-sparkle-spinner--animate-sparkle': loading === RemoteDataState.Loading,
  })

  const loadingStatus = classnames('cf-sparkle-spinner--logo', {
  ...
  return (
    ...
    >
      ...
      >
        <path
          className={`cf-sparkle-spinner--fill-medium cf-sparkle-spinner--delay-3 ${animationState}`}
...
C250,9.2,250,9.2,250,9.1L250,9.1L250,9.1C250,9.2,250,9.1,250,9.1C250,9.1,250,9.1,250,9.1z"
        />
        <path
          className={`cf-sparkle-spinner--fill-dark cf-sparkle-spinner--delay-1 ${animationState}`}
...
C168.5,187.9,168.5,187.9,168.5,187.9z"
        />
        <circle
          className={`cf-sparkle-spinner--fill-light cf-sparkle-spinner--delay-2 ${animationState}`}
          cx="231.5"
          cy="171.2"
          r="3.5"
        />
...
c1.4-0.4,2.7,0.5,3.1,1.9l9.2,40C171.6,136.5,170.7,137.9,169.4,138.1z"
        ...
        <g>
          <line
            className={`cf-sparkle-spinner--stroke cf-sparkle-spinner--stroke-medium cf-sparkle-spinner--delay-2 ${animationState}`}
            x1="30"
            y1="90.4"
            x2="30"
            y2="104.4"
        ...
        <g>
          <line
            className={`cf-sparkle-spinner--stroke cf-sparkle-spinner--stroke-light cf-sparkle-spinner--delay-2 ${animationState}`}
            x1="165.7"
            y1="12.9"
            x2="165.7"
            y2="19.9"
        ...
        <g>
          <line
            className={`cf-sparkle-spinner--stroke cf-sparkle-spinner--stroke-dark cf-sparkle-spinner--delay-3 ${animationState}`}
            x1="5.1"
            y1="241.4"
            x2="5.1"
            y2="248.4"
        ...
        <g>
          <line
            className={`cf-sparkle-spinner--stroke cf-sparkle-spinner--stroke-light cf-sparkle-spinner--delay-3 ${animationState}`}
            x1="176.5"
            y1="224.2"
            x2="171.5"
            y2="229.2"
  ...
  c-1.9,0-3.5,1.6-3.5,3.5c0,1.9,1.6,3.5,3.5,3.5c1.9,0,3.5-1.6,3.5-3.5C105.1,51.8,103.6,50.2,101.6,50.2L101.6,50.2z"
        />
        <path
          className={`cf-sparkle-spinner--fill-dark cf-sparkle-spinner--delay-2 ${animationState}`}
  ...
  C51.2,165.3,51.2,165.3,51.2,165.3C51.2,165.3,51.2,165.3,51.2,165.3L51.2,165.3z"
        />
        <path
          className={`cf-sparkle-spinner--fill-medium cf-sparkle-spinner--delay-1 ${animationState}`}
...
SparkleSpinner.displayName = 'SparkleSpinner'
