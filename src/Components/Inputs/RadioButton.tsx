...
export interface RadioButtonProps extends Omit<StandardFunctionProps, 'id'> {
  /** Unique identifier for this RadioButton */
  id: string
  ...
  /** Controls color of RadioButton */
  color?: ComponentColor
  /** Renders the RadioButton as either "Solid" or "Outline" */
  appearance?: Appearance
}

export type RadioButtonRef = HTMLInputElement
export type RadioButtonContainerRef = HTMLDivElement
